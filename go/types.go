// Package texttocolor provides a Go client for the Text to Color API.
//
// For more information, visit: https://apiverve.com/marketplace/texttocolor?utm_source=go&utm_medium=readme
package texttocolor
...
// Request contains the parameters for the Text to Color API.
//
// Parameters:
//   - color (required): string - The text to convert the color from
type Request struct {
...
// ResponseData contains the data returned by the Text to Color API.
type ResponseData struct {
	...
	Ansi16 int `json:"ansi16"`
	Channels ChannelsData `json:"channels"`
}

// ChannelsData represents the channels object.
type ChannelsData struct {
	RgbChannels int `json:"rgbChannels"`
	CmykChannels int `json:"cmykChannels"`
	AnsiChannels int `json:"ansiChannels"`
	HexChannels int `json:"hexChannels"`
	HslChannels int `json:"hslChannels"`
}
