...
const (
	baseURL        = "https://api.apiverve.com/v1/texttocolor"
	defaultTimeout = 30 * time.Second
)

// Client is the Text to Color API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Text to Color API client.
...
// Execute makes a request to the Text to Color API with typed parameters.
//
