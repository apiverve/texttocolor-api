# Text to Color API - Examples

This folder contains example code for using the Text to Color API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/texttocolor',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/texttocolor");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/texttocolor](https://docs.apiverve.com/ref/texttocolor)
