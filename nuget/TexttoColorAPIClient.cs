...
namespace APIVerve.API.TexttoColor
{
    ...
    /// <summary>
    /// Client for the TexttoColor API
    /// </summary>
    public class TexttoColorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/texttocolor";
        ...
        {
            { "color", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public TexttoColorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TexttoColorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TexttoColorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TexttoColorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TexttoColorQueryOptions options)
        {
        ...
        public ResponseObj Execute(TexttoColorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TexttoColorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TexttoColorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TexttoColorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TexttoColorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TexttoColorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TexttoColorQueryOptions options)
        {
