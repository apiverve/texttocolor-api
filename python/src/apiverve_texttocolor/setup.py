...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/texttocolor',
        'Source': 'https://github.com/apiverve/texttocolor-api',
        'Bug Tracker': 'https://github.com/apiverve/texttocolor-api/issues'
    },
    classifiers=[
