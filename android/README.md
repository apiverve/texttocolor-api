...
```gradle
dependencies {
    implementation 'com.github.apiverve:texttocolor-api:1.1.14'
}
```
...
```java
import com.apiverve.texttocolor.TexttoColorAPIClient;
import com.apiverve.texttocolor.APIResponse;
import com.apiverve.texttocolor.APIException;

// Initialize the client
TexttoColorAPIClient client = new TexttoColorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("color", "turquoise");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/texttocolor](https://docs.apiverve.com/ref/texttocolor)
...
- **Documentation:** [https://docs.apiverve.com/ref/texttocolor](https://docs.apiverve.com/ref/texttocolor)
- **Issues:** [GitHub Issues](https://github.com/apiverve/texttocolor-api/issues)
